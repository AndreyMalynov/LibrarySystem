    ...
    class XmlSource : IData
    {
        ...
        public void OpenOrCreateBooks()
        {
            try
            {
                ...
                try
                {
                    using (FileStream fs = new FileStream(("../../AppData/BooksFromXml.xml"), FileMode.OpenOrCreate))
                    {
        ...
        public void SaveBooksChanges()
        {
            try
            {
                using (FileStream fs = new FileStream(("../../AppData/BooksFromXml.xml"), FileMode.Create))
                {
                    formatterBooks.Serialize(fs, Books);
                }
            }
